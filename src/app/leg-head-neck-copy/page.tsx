...
function calc(t: TestResult): LegResult {
  ...
  if (t.height >= 170) {
    ...
    if ((t.leg / t.torso) * t.headNeck >= 30) {
      return "long";
    }
    if ((t.leg / t.torso) * t.headNeck >= 28) {
      return "slightlyLong";
    }
    if ((t.leg / t.torso) * t.headNeck >= 26) {
      return "balanced";
    }
    if ((t.leg / t.torso) * t.headNeck >= 24) {
  ...
  if (t.height >= 160) {
    ...
    if ((t.leg / t.torso) * t.headNeck >= 27) {
      return "long";
    }
    if ((t.leg / t.torso) * t.headNeck >= 25) {
      return "slightlyLong";
    }
    if ((t.leg / t.torso) * t.headNeck >= 23) {
      return "balanced";
    }
    if ((t.leg / t.torso) * t.headNeck >= 21) {
      return "slightlyShort";
    }
    return "short";
  }
  ...
  if ((t.leg / t.torso) * t.headNeck >= 22) {
    return "balanced";
  }
  if ((t.leg / t.torso) * t.headNeck >= 20) {
    return "slightlyShort";
  }
  return "short";
}
  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between items-center">
        <p>(leg / torso) * headneck:</p>
        <p>{((t.leg / t.torso) * t.headNeck).toFixed(4)}</p>
      </div>
      <div className="flex flex-row justify-between items-center">
        <p>height:</p>
